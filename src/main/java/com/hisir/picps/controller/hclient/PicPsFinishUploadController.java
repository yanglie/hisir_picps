...
@RestController
public class PicPsFinishUploadController {

	private static final Log log = LogFactory.getLog(PicPsFinishUploadController.class);
	...
	@RequestMapping(value = "/picps/picps_finish_upload", method = RequestMethod.POST)
